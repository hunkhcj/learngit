...
# eg:
echo `date` >> /var/log/cloudinit.log
echo "[Info] Config for jumpserver. host_name: ${host_name}, project_name: ${project_name}" >> /var/log/cloudinit.log
...
## End log
echo "[Info] Config all done." >> /var/log/cloudinit.log
